...
const MyVid = () => {
  ...
  useEffect(() => {
    const getMyVideos = async () => {
      const res = await axios.get(
        `https://video-streaming-backend.onrender.com/api/videos/get/${currentUser._id}`,
        {
          headers: {
  ...
  const updateClick = async () => {
    ...
    const res = await axios.put(
      `https://video-streaming-backend.onrender.com/api/videos/update/${currentVideo._id}`,
      currentVideo,
      {
        headers: {
          token: "Bearer " + currentUser.accessToken,
  ...
  const deleteClick = async () => {
    ...
    const res = await axios.delete(
      `https://video-streaming-backend.onrender.com/api/videos/delete/${currentVideo._id}`,
      {
        headers: {
          token: "Bearer " + currentUser.accessToken,
        },
